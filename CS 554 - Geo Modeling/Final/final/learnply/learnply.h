...
public:
  ...
  PlyOtherProp *vert_other,*face_other;
	...
	// Add curvature bounds
  double min_mean_curvature;
  double max_mean_curvature;
  double min_gauss_curvature;
