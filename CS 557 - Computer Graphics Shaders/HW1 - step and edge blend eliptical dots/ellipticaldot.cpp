...
//	This is the sample OpenGL / GLUT program 
//  I have updateded it fot the Step- and Blended-edged Elliptical Dots homework one 

// title of these windows:

const char *WINDOWTITLE = "Step- and Blended-edged Elliptical Dots  -- Alexis";
